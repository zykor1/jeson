...
DATABASES = {
    'default': {
        ...
        'NAME': 'db_json',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '8p=3r6_#+a&-x#03u0&7op_#5^*rwe-i%umvvaagiw-f0#of19'
...
ROOT_URLCONF = 'jeson.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'jeson.wsgi.application'
